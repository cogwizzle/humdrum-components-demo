...
/***/ (function(module, exports, __webpack_require__) {
    ...
    riot.tag2('header_nav', '<ul ref="page_heading" id="page_heading" class="c-nav c-nav--inline"> <yield></yield> <li id="page_heading_text" class="c-nav__content" if="{opts.page_heading}">{opts.page_heading}</li> <span class="navspan" if="{opts.links}"> <li class="icon c-nav__item--right" onclick="{toggleResponsive}">&#9776;</li> <li each="{opts.links}" class="c-nav__item c-nav__item--right" uri="{uri}" onclick="{goto}">{text}</li> </span> </ul>', 'header_nav body,[data-is="header_nav"] body{ margin:0; } header_nav ul#page_heading #page_heading_text,[data-is="header_nav"] ul#page_heading #page_heading_text{ font-weight: bold; } header_nav ul#page_heading li.icon,[data-is="header_nav"] ul#page_heading li.icon{ vertical-align: center; text-align: center; } header_nav ul.topnav li a,[data-is="header_nav"] ul.topnav li a{ display: inline-block; color: #f2f2f2; text-align: center; padding: 14px 16px; text-decoration: none; transition: 0.3s; font-size: 17px; } header_nav ul#page_heading li,[data-is="header_nav"] ul#page_heading li{ position:relative; } header_nav ul#page_heading li a,[data-is="header_nav"] ul#page_heading li a{ color: #f2f2f2; text-align: center; text-decoration: none; transition: 0.3s; height:100%; } header_nav ul#page_heading li.icon,[data-is="header_nav"] ul#page_heading li.icon{ display: none; padding: 16px; } header_nav ul#page_heading,[data-is="header_nav"] ul#page_heading{ z-index:100; } @media screen and (max-width:680px) { header_nav ul#page_heading li.c-nav__item--right,[data-is="header_nav"] ul#page_heading li.c-nav__item--right{ display: none; } header_nav ul#page_heading li.icon,[data-is="header_nav"] ul#page_heading li.icon{ display: inline-block; } header_nav ul#page_heading.responsive,[data-is="header_nav"] ul#page_heading.responsive{ position: relative; } header_nav ul#page_heading.responsive li.c-nav__item,[data-is="header_nav"] ul#page_heading.responsive li.c-nav__item{ float: none; display: block; } header_nav ul#page_heading.responsive li.c-nav__item a,[data-is="header_nav"] ul#page_heading.responsive li.c-nav__item a{ display: block; text-align: left; margin-left:16px; } header_nav ul#page_heading.responsive li.c-nav__item:hover,[data-is="header_nav"] ul#page_heading.responsive li.c-nav__item:hover{ display:block; } }', '', function(opts) {
'use strict';
